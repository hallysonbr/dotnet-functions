...
{
    public class Logger500Processor : LoggerBase
    {
        public Logger500Processor(IDataService dataService) : base(dataService) { }

        [FunctionName("Logger500Processor")]
        public async Task Run([EventHubTrigger("logapim500", Connection = "EventHubConnectionString")] EventData[] events, ILogger log)
        {
